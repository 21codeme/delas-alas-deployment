...
async function generateTimeSlotsForService(serviceType, timeGrid) {
    ...
    timeSlots.forEach(time => {
        ...
        if (isBooked) {
            ...
            // Set FULLY BOOKED on top, time below
            slot.innerHTML = `<div style="font-size: 10px; font-weight: 600; margin-bottom: 2px;">FULLY BOOKED</div><div style="font-size: 12px;">${formatTime(time)}</div>`;
        } else {
