...
async function generateTimeSlotsForService(serviceType, timeGrid) {
    ...
    timeSlots.forEach(time => {
        ...
        if (isBooked) {
            ...
            // Set FULLY BOOKED on top, time below - only once
            const timeText = formatTime(time);
            slot.innerHTML = `<div style="font-size: 10px; font-weight: 600; margin-bottom: 2px; line-height: 1.2;">FULLY BOOKED</div><div style="font-size: 12px; line-height: 1.2;">${timeText}</div>`;
        } else {
